                ...
                <form class="layui-form" action="" style="width: 50%;margin: 0 auto;margin-top: 20px;">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block serchLocation">
                            <input v-model="keyword" type="text" name="chargingStationLocation" id="chargingStationLocation" required lay-verify="required" autocomplete="on" placeholder="请选择地理位置" class="layui-input">
                            <i class="layui-icon" @click="searchByStationName">&#xe615;</i>
                        </div>
...
<#--some js-->
<script src="/js/pagejs/updateChargingStation.js"></script>
</html>
